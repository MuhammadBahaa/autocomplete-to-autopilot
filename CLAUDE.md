...
- **`cvWorthy: true` is deliberately scarce.** It prints the gold ★ badge and
  turns that entry's dot on the timeline rail accent-coloured. Eight entries
  carry it — the measurable delivery, the skills discovery, the workflow seen
  end to end, the production tooling, the first public release, the team
  adoption, the platform, the public distribution. It marks shipped outcomes
  and the rare moment that redirected the journey, not good days; spreading it
  further is what would break it. The badge
